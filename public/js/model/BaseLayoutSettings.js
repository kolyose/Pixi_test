export default class BaseLayoutSettings{
    ...
    getFragmentDimensionsByFragmentsNumber(fragmentsNumber){                
        const width = this.imageDimensions.width/this.getColumnsByFragmentsNumber(fragmentsNumber);
        const height = this.imageDimensions.height/this.getRowsByFragmentsNumber(fragmentsNumber);
        return {width, height};
    }
